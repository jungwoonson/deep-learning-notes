...
분류와 회귀에서 각각의 손실 함수를 간단히 살펴봤다. 이제 다양한 손실 함수들과 경사 하강법의 변형들을 더 깊이 알아보자.

**다음**: [손실 함수와 최적화 (Loss Functions and Optimization)](./04-loss-functions-optimization.md) - MSE, 교차 엔트로피 외에도 다양한 손실 함수가 있으며, 경사 하강법에도 여러 변형이 있다.

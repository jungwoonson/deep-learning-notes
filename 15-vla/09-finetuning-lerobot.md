...
**다음**: [Fairino FR3 배포](./10-fairino-fr3-deployment.md) - 커리큘럼의 최종 노트. 파인튜닝된 VLA를 실제 Fairino FR3 로봇에 배포하는 전체 파이프라인. 데이터 수집부터 안전한 실시간 제어 루프까지, 그리고 이 커리큘럼 전체의 요약과 미래 방향.
